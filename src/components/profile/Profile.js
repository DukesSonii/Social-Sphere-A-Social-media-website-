...
function Profile() {
  ...
  }, [myProfile, params.userId, feedData]); //tino chheza update ho rhi h
    ...
    <div className="Profile">
      <div className="container">
        <div className="left-part">
          {/*agar apan dusre ke profile pe h toh we cant see create post, sirf apni profile pe hi dekhega  */}
        ...
        <div className="right-part">
          <div className="profile-card">
            ...
            {/* agar mere profile h toh show this update button  */}
            {!isMyProfile && (
              <h5
